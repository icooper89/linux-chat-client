...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        lineEdit_2->setGeometry(QRect(0, 450, 411, 27));
        textBrowser = new QTextBrowser(centralWidget);
        textBrowser->setObjectName(QString::fromUtf8("textBrowser"));
        textBrowser->setGeometry(QRect(0, 0, 471, 451));
        pushButton = new QPushButton(centralWidget);
        pushButton->setObjectName(QString::fromUtf8("pushButton"));
        pushButton->setGeometry(QRect(410, 450, 61, 27));
        textBrowser_2 = new QTextBrowser(centralWidget);
        textBrowser_2->setObjectName(QString::fromUtf8("textBrowser_2"));
        textBrowser_2->setGeometry(QRect(470, 0, 151, 471));
        ...
        menuConnection->addAction(actionOptions);
